...
const FAQS: { q: string; a: ReactNode; text: string }[] = [
  {
    ...
    a: (
      <>
        TalkAbtIT adds a time-stamped comment section to the streaming services
        you already use. Every comment is pinned to the exact moment in the show,
        so you can react together — even when you&apos;re watching on your own
        time.
      </>
    ),
    text: "TalkAbtIT adds a time-stamped comment section to the streaming services you already use. Every comment is pinned to the exact moment in the show, so you can react together — even when you're watching on your own time.",
  },
  {
    ...
    a: (
      <>
        ...
        TalkAbtIT, with more coming soon. You can watch right inside the app, or
        keep playing on your TV and follow the comments on your phone.
      </>
    ),
    text: "Netflix, Hulu, Disney+, Max, Prime Video, and Crunchyroll work with TalkAbtIT, with more coming soon. You can watch right inside the app, or keep playing on your TV and follow the comments on your phone.",
  },
  {
  ...
  },
  {
    ...
    text: "Yes. Keep playing on your TV and use TalkAbtIT as a second screen — the comments stay synced to the show's runtime while you watch on the big screen.",
  },
  {
    q: "How do I sign up?",
    a: (
    ...
    text: "Download the app and sign in with your Apple ID, then pick a username — that's the name everyone sees next to your comments. The whole thing takes a few seconds.",
  },
  {
    q: "Is it free?",
    a: (
      <>
        ...
        have. An optional Premium upgrade unlocks extra customization like
        avatars, colors, and comment styling.
      </>
    ),
    text: "Yes — the core experience is free with the subscriptions you already have. An optional Premium upgrade unlocks extra customization like avatars, colors, and comment styling.",
  },
  {
    q: "What can I customize?",
    a: (
      <>
        With Premium you can personalize how you show up in the conversation —
        avatars, name and bubble colors, and more — so your comments look like
        you.
      </>
    ),
    text: "With Premium you can personalize how you show up in the conversation — avatars, name and bubble colors, and more — so your comments look like you.",
  },
  {
    ...
    text: "Every comment can be reported from the app, and you can block users you don't want to hear from. We review reports and remove content that breaks our community guidelines.",
  },
  {
    q: "Which devices are supported?",
    a: <>TalkAbtIT is available on iPhone. Support for more devices is on the way.</>,
    text: "TalkAbtIT is available on iPhone. Support for more devices is on the way.",
  },
  {
    ...
    text: "You can delete your account from within the app at any time, which removes your profile and associated data. See our Privacy Policy for what happens to your information when you do.",
  },
];
