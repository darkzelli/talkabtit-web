...
// gd = offset into the shared 35s glow cycle (10 slots of 3.5s), so exactly one
...
const BG_LOGOS = [
  ...
  { href: "/disney-plus/", label: "Disney+ comment section", src: "/logos/disneyplus.svg", x: 84, y: 54, h: 52, r: -4, gd: 24.5 },
