...
const STEPS = [
  ...
  },
  {
    ...
    body: "Head to Netflix, Hulu, Disney+, Max, Prime Video, or Crunchyroll and press play — the popcorn bucket pops up over the video. Click it to open the conversation.",
    visual: <BucketDemo />,
  },
  {
